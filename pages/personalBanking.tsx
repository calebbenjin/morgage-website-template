      ...
      <HeroWrapper>
        <div className="container mx-auto flex items-center justify-between flex-wrap md:flex-wrap lg:flex-nowrap">
          <div className="hero-content">
            <h1 className="text-3xl sm:text-5xl font-bold animate__bounceIn text-white capitalize">Online Personal Banking</h1>
...
const HeroWrapper = styled.div`
  ...
  align-items: center;
  overflow: none;
  background-image: linear-gradient(to right, rgba(0, 0, 0, 0.689), rgba(0, 0, 0, 0)), url(./img6.jpeg);
